...
function App() {
    ...
    return (
        <BrowserRouter>
            <Navbar passBackgroundColor={setBackgroundColor} passSetIsMessageAdded={setIsMessageAdded}
            ...
            <Routes>
                <Route element={<RequireAuthentication allowedRoles={[ROLES.UNNECESSARY]} isBlocked={isBlocked}
                                                       role={role}/>}>
                    <Route path="/" element={<Home isDeleted={isIssueDeleted} isAdded={isIssueAdded}
                                                   isUpdated={isIssueUpdated}/>}/>
                </Route>
                <Route element={<RequireAuthentication allowedRoles={[ROLES.UNNECESSARY]} isBlocked={isBlocked}
                                                       role={role}/>}>
                    <Route path="/issues"
                           element={<Issues passBackgroundColor={backgroundColor} isDeleted={isIssueDeleted}
                                            setIsDeleted={setIsIssueDeleted} isUpdated={isIssueUpdated}
                                            setIsUpdated={setIsIssueUpdated} isAdded={isIssueAdded}/>}/>
                </Route>
                <Route
                    element={<RequireAuthentication allowedRoles={[ROLES.CITIZEN]} isBlocked={isBlocked} role={role}/>}>
                    <Route path="/profile"
                           element={<MyProfile passIsDeleted={isIssueDeleted} passIsUpdated={isIssueUpdated}
                                               passSetIsIssueUpdated={setIsIssueUpdated}
                                               passBackgroundColor={backgroundColor}/>}/> </Route>
                <Route element={<RequireAuthentication allowedRoles={[ROLES.UNNECESSARY]} isBlocked={isBlocked}
                                                       role={role}/>}>
                    <Route path="/map"
                ...
                <Route
                    element={<RequireAuthentication allowedRoles={[ROLES.ADMIN]} isBlocked={isBlocked} role={role}/>}>
                    <Route path="/citizens"
                           element={<Citizens passIsDeleted={isIssueDeleted} passBackgroundColor={backgroundColor}/>}/>
                </Route>
                <Route path="/login" element={<LoginComponent login={isLoggedIn} onLogin={setIsLoggedIn}/>}/>
                ...
                <Route element={<RequireAuthentication allowedRoles={[ROLES.CITIZEN, ROLES.ADMIN]} isBlocked={isBlocked}
                                                       role={role}/>}>
                    <Route path="/chat" element={<MyChat passBackgroundColor={backgroundColor} passPersons={persons}
                                                         passSetPersons={setPersons}
                                                         passReceivedNewUserMessage={receivedNewUserMessage}
                                                         passIsMessageAdded={isMessageAdded}
                                                         passSetIsMessageAdded={setIsMessageAdded}/>}/>
                </Route>
            </Routes>
        </BrowserRouter>
    );
